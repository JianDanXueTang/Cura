...
class SliceInfo(Extension):
    ...
    def __init__(self):
        ...
        if not Preferences.getInstance().getValue("info/asked_send_slice_info"):
            ...
            #★ 修改 准备视图底部的“切片信息”弹窗内容显示cura字样 为 3Dtakers
            ...
            self.send_slice_info_message = Message(catalog.i18nc("@info", "3Dtakers collects anonymised slicing statistics. You can disable this in the preferences."), lifetime = 0, dismissable = False)
            #修改状态：√ 成功 隐藏，但！i18n还没修改
