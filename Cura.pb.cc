...
void protobuf_AssignDesc_Cura_2eproto() {
  ...
  static const int PrintTimeMaterialEstimates_offsets_[12] = {
...
void protobuf_AddDesc_Cura_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\004data\030\002 \001(\014\"\021\n\017SlicingFinishedb\006proto3", 1839);
...
#define ZR_(first, last) do {\
  ...
  ZR_(time_travel_, time_retract_);
  time_support_interface_ = 0;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 11: {
        ...
        if (input->ExpectTag(98)) goto parse_materialEstimates;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(98)) goto parse_loop_materialEstimates;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
