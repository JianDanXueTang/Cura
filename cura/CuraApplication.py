...
if not MYPY:
    try:
        ...
        #★书签，修改启动界面，改master为Udi-link （√）
        #CuraVersion = "master"  # [CodeStyle: Reflecting imported value]
        CuraVersion = "Udi-link"  # [CodeStyle: Reflecting imported value]
...
class CuraApplication(QtApplication):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(Resources.getPath(Resources.Images, "UDI-Link-icon.png")))
