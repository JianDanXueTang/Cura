...
UM.MainWindow
{
    ...
    title: catalog.i18nc("@title:window","3Dtakers");
    //修改状态： √ 成功
    ...
    Item
    {
        ...
        Item
        {
            ...
            Image
            {
				...
				//★修改图标：修改主界面左下角的cura图标（对应文件为logo.svg）为3Dtakers.svg(√)
				//★隐藏图标：注释掉下面3行，或将代码中的“logo”或文件名改为非logo，可以不显示。替换的话3Dtakers.svg命名为logo.svg
                //★ 隐藏主界面左下角的cura图标
